  ...
  return (
    <div className="container-page py-8">
      ...
      <p className="mt-1 text-slate-600">
        Проверьте знания по профилю. Проходной балл — 70%. Успешная сдача
        автоматически отмечает этап на карте развития.
      </p>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {tests.map((t) => {
          ...
          return (
            <Link key={t.id} href={`/tests/${t.id}`} className="card card-hover flex flex-col p-6">
              ...
              <span className="btn-outline mt-4">
